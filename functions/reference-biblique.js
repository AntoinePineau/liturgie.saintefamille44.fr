...
function parseReference(reference) {
  ...
  if (reference.includes('Ps')) {
    const [psalm, ...verseParts] = reference.split(' ');
...
// Endpoint pour obtenir le texte biblique
app.get('/api/bible/:reference', (req, res) => {
  ...
  // Lire le fichier livres.json pour obtenir les informations du livre
